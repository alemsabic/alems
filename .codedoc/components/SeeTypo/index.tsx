...
export function SeeTypo(
  ...
  return <div style="text-align:center; margin-top:64px;"><span class="icon-font" data-ignore-text="" style="vertical-align: sub">create</span><a href={href}> Briši greške.</a></div>
}
