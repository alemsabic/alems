...
export function SeeTypo(
  ...
  return <p><b>Briši greške.</b> Ako nađeš grešku (a grešaka more), <a href={href}>onda dotjeraj malo stranicu <span class="icon-font" style="vertical-align: sub">edit</span></a>. Hvala.</p> 
}
